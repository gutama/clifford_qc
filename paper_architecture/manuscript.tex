...
sub-object; \cqcRecordsRoleOnly{} declare an evidence \emph{role} --- what the
record is for --- with no tier at all, which is a different statement and is
not counted as one here; and \cqcRecordsUnlabelled{} carry no record-level
evidence field whatsoever.  A further \cqcSeriesFiles{} series files --- line-delimited JSON, CSV and

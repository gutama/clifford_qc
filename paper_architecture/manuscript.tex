...
top level, but the broader record-label vocabulary is not normalized and is not
enforced by a schema over the record set: nothing today rejects a new record
that omits the field.  The
